...
/**
 * depreceated class used to implement custom youtube player unfortunately didnt work
 */
...
public class CustomPlayerUiController extends AbstractYouTubePlayerListener implements YouTubePlayerFullScreenListener {
    ...
    private void initViews(View playerUi){
        ...
        playPauseButton.setOnClickListener( (view) -> {
            if(youTubePlayerTracker.getState() == PlayerConstants.PlayerState.PLAYING) youTubePlayer.pause();
